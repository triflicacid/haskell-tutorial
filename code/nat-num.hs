...
div :: NatNum -> NatNum -> NatNum -- Function to divide two naturals
div a Zero = error "Can't divide by zero"
div a (Succ Zero) = a -- a/1 = a
div Zero b = Zero -- 0/b = 0
div a b = div_h a b Zero
  where
    div_h Zero b n = n
